...
bool T3_InputSystem_GetMouseUp(T3_Input_Mouse_Button button) {
    bool prev = T3_HELPER_FLAG_CHECK_OPTION(SDL_BUTTON(button), inputSystem->MouseStatePrevious);
    bool current = T3_HELPER_FLAG_CHECK_OPTION(SDL_BUTTON(button), inputSystem->MouseStateCurrent);
