...
T3_Component *T3C_Sprite_Init (T3C_Texture *texture, SDL_Rect rect, float anchorX, float anchorY) {
    ...
    sprite->component.OnDestroy = T3C_Sprite_OnDestroy;
...
T3_Component *T3C_SpriteRenderer_Init (void) {
    ...
    spriteRenderer->component.OnDestroy = T3C_Sprite_OnDestroy;
    spriteRenderer->component.OnAddComponent = T3C_SpriteRenderer_OnAddComponent;
    spriteRenderer->component.OnLoop = T3C_SpriteRenderer_OnLoop;
